...
<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@600&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <section class="cd-hero">
          ...
          <div class="cd-slider-nav">
            <nav>
              ...
              <ul>
                ...
                <li><a href="#0"><div class="image-icon"><img src="img/projects-icon.png"></div><h6>Courses</h6></a></li>
                <li><a href="#0"><div class="image-icon"><img src="img/contact-icon.png"></div><h6>Contact Us</h6></a></li>
                <bi><a href="/welcome-ar" style="text-decoration: none;font-family: 'Cairo', sans-serif;"><div class="image-icon" style="margin: 0 auto;"><img src="img/lang-icon.png"></div><h6 style="font-size: 18px;color: white;">العربية</h6></a></bi>
              </ul>
            </nav> 
          </div> <!-- .cd-slider-nav -->
          ...
          <ul class="cd-hero-slider">
            ...
            <li class="selected">
              <div class="heading">
                <h1>SmarTech</h1>
                <span>Welcome To SmarTech WebSite</span>
              </div>
            ...
            <li>
              <div class="heading">
                <h1>Our courses</h1>
                <span>Here you can check our recent courses</span> 
              </div>
        ...
        <footer>
          <p>Copyright &copy; 2021 SmarTech 
                                
        	| Designed by <em>Bilal Katbi</em></p>
        </footer>
